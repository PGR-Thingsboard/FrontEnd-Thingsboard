...
/*@ngInject*/
export default function AssignCultivoToCustomerController(customerService, cultivoService, $mdDialog, $q, cultivoIds, customers) {
    ...
    function assign() {
        ...
        for (var i=0;i<cultivoIds.length;i++) {
            tasks.push(cultivoService.assignCultivoToCustomer(vm.customers.selection.id.id, cultivoIds[i]));
        }
