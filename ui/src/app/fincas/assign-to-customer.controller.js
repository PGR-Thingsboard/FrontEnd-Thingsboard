...
/*@ngInject*/
export default function AssignFincaToCustomerController(customerService, fincaService, $mdDialog, $q, fincaIds, customers) {
    ...
    function assign() {
        ...
        for (var i=0;i<fincaIds.length;i++) {
            tasks.push(fincaService.assignFincaToCustomer(vm.customers.selection.id.id, fincaIds[i]));
        }
