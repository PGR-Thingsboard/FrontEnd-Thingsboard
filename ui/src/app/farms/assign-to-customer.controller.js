...
/*@ngInject*/
export default function AssignFarmToCustomerController(customerService, farmService, $mdDialog, $q, farmIds, customers) {
    ...
    function assign() {
        ...
        for (var i=0;i<farmIds.length;i++) {
            tasks.push(farmService.assignFarmToCustomer(vm.customers.selection.id.id, farmIds[i]));
        }
